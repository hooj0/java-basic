...
public class MathTest {
	...
	public static void main(String[] args) {
		...
		System.out.println("Math.atin(2.3): " + Math.atan(2.3));
		
		//计算三角余弦
		System.out.println("Math.cos(2.3):" + Math.cos(2.3));
		//计算双曲线余弦
		...
		//取整，返回大于目标数的最大整数
		System.out.println("Math.cell(1.2): " + Math.ceil(1.2));
		...
		//计算自然对数
		System.out.println("Math.log(1.2): " + Math.log(1.2));
		//计算底数为10的对数
		...
		//找出最大值
		System.out.println("Math.max(2.3, 2.4): " + Math.max(2.3, 2.4));
		//找出最小值
